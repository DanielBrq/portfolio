            ...
            <div id="title"
                ...
                <div class="relative inline-flex items-center justify-center">
                    <h1 ref="nameEl" aria-label="Daniel Barquero Cabrera"
                        class="niel-gradient-w text-6xl text-center font-extralight uppercase tracking-[0.5em] leading-20 name">
                    </h1>
                    <span ref="nameCursorEl"
                        class="typing-cursor niel-gradient-w text-6xl font-extralight leading-20"
                        style="opacity: 0;">|</span>
                </div>
                <div class="relative inline-flex items-center justify-center">
                    <h3 ref="jobEl" aria-label="Full Stack Developer"
                        class="text-niel-primary-100 text-xl text-center font-light uppercase tracking-[1em] hover:saturate-150">
                    </h3>
                    <span ref="jobCursorEl"
                        class="typing-cursor text-niel-primary-100 text-xl font-light leading-none"
                        style="opacity: 0;">|</span>
                </div>
            </div>
