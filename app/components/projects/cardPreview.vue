    ...
    <div class="flex items-center gap-3">
        <div :class="[
            ...
            <div class="relative flex flex-col h-full p-8 sm:p-10">
                ...
                <div class="flex flex-wrap items-start justify-between gap-4 mb-4">
                    ...
                    <div class="shrink-0 mt-1">
                        <span :class="[
                            ...
                            <span class="w-1.5 h-1.5 rounded-sm mr-2"
                                :class="props.repositoryPrivate ? 'bg-rose-400' : 'bg-emerald-400'"></span>
                            {{ repoVisibility }}
                        </span>
                    </div>
                </div>
                ...
                <div
                    class="flex flex-wrap items-center gap-4 sm:gap-6 mt-auto pt-6 border-t border-white/5">
                    ...
                    <nuxt-link v-if="to" :to="to"
                        ...
                        <span class="text-sm sm:text-base font-light tracking-wide">{{ $t("projects.detailsButton")
                            }}</span>
                        <IconFolder
