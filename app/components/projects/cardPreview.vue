...
<template>
  <div class="flex items-center gap-3">
    <div :class="[
      ...
      <div class="relative flex flex-col h-80 p-8 sm:p-10">
        <div class="flex flex-wrap items-start justify-between gap-4 mb-4">
          <h3
            class="text-niel-primary-200 text-xl sm:text-2xl md:text-3xl font-light uppercase tracking-[0.15em] font-serif">
            {{ title }}
          </h3>
        ...
        <div class="flex flex-wrap items-center gap-4 sm:gap-6 mt-auto pt-6 border-t border-white/5">
