...
<template>
  <section class="w-screen h-dvh scrollbar-none overscroll-y-none relative overflow-hidden z-1 bg-app-bg">
    ...
    <video autoplay muted loop playsinline class="w-full object-cover opacity-65 z-10">
    ...
    <div ref="content" class="w-full h-full absolute inset-0 z-10">
      <div
        ...
        <div id="title" class="grid h-full grid-rows-5 gap-2 items-center desktop:items-start z-10 select-none">
          <div class="row-span-1"></div>
          <div class="row-span-1 flex flex-col justify-end">
            <div class="relative inline-flex items-center justify-center">
              <h1 ref="nameEl" aria-label="Daniel Barquero Cabrera"
                class="niel-gradient-h text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-center desktop:text-left font-light uppercase tracking-[0.15em] md:tracking-[0.30em] leading-tight font-serif name animate-pulse-name">
              </h1>
              <span ref="nameCursorEl"
                class="typing-cursor text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extralight leading-tight"
            ...
            <div class="relative inline-flex flex-col items-center desktop:items-start justify-center group">
              <h3 ref="jobEl" aria-label="Full Stack Developer"
                class="niel-gradient-gold-h text-xs sm:text-sm md:text-base lg:text-xl text-center desktop:text-left font-light uppercase tracking-[0.2em] sm:tracking-[0.25em] md:tracking-[0.3em] lg:tracking-[0.35em] desktop:tracking-[0.4em] font-serif animate-pulse-job">
              </h3>
