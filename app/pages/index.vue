        ...
        <div id="title" class="grid h-full grid-rows-5 gap-2 items-center desktop:items-start z-10 select-none">
          ...
          <div class="row-span-1 flex flex-col justify-end">
            <div class="relative inline-flex items-center justify-center">
              <h1 ref="nameEl" aria-label="Daniel Barquero Cabrera" class="niel-gradient-h text-2xl sm:text-3xl md:text-4xl lg:text-5xl desktop:text-5xl text-center desktop:text-left font-light 
              uppercase tracking-[0.15em] md:tracking-[0.30em] leading-tight font-serif name animate-pulse-name">
              </h1>
