  ...
  <div class="w-dvw h-dvh overflow-hidden flex flex-col items-center justify-center py-10">
    ...
    <nav class="flex flex-col gap-4 w-full max-w-xl px-4 mt-12 z-10">
        ...
        <div class="flex items-center justify-center w-10 h-10 opacity-65 group-hover:opacity-100 transition-opacity">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor"
            ...
            <path stroke-linecap="round" stroke-linejoin="round"
              d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.225 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
          </svg>
        </div>
      ...
      <a href="https://www.linkedin.com/in/danielbrq/" target="_blank" rel="noopener noreferrer"
        ...
        <div class="flex flex-col gap-1">
          <span class="text-xs uppercase tracking-[0.25em] text-app-text-muted font-light">{{
            t('contact.labels.linkedin') }}</span>
          <span class="text-base text-app-text-muted lowercase tracking-wider font-light">/in/danielbrq</span>
        </div>
      </a>
